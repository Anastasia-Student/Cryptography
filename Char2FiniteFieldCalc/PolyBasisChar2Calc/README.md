...
The file *PolyNormGF.h* is an efficient implementation of operations in a Galois field of characteristic 2 in a polynomial basis. It considers $GF(2^{191})$ with generator $g(x) = x^{191} + x^9 + 1$. An example of its operation can be seen below.
